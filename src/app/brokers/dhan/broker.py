...
class DhanBroker(BrokerInterface):
    """Future Dhan implementation placeholder."""
    ...
    def _unsupported(self) -> NoReturn:
        raise BrokerNotSupportedException("Dhan broker is not yet implemented")
    ...
    def health(self) -> BrokerHealth:
        return BrokerHealth(
            broker_code=BrokerCode.DHAN.value,
