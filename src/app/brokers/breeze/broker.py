...
class BreezeBroker(BrokerInterface):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize Breeze broker."""
        self._config = config
        self._event_bus = event_bus
        self._lock = RLock()
        self._state = ConnectionState.DISCONNECTED
        api_key = credential_manager.get_api_key(config.account_name) or ""
        ...
        self._session = BreezeSessionManager(self._auth, config)
    ...
    def connect(self) -> None:
        ...
        with self._lock:
            if not self._auth.session_token and self._config.auto_login:
