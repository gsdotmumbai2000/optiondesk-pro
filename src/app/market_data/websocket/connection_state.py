...
from app.brokers.events import (
...
class ConnectionStateMachine:
    ...
    def start(self) -> None:
        ...
        self._event_bus.subscribe(AuthenticationSucceededEvent, self._handle_connected)
    ...
    def _handle_connected(self, _event: object) -> None:
        ...
        self._publish(ReconnectStartedEvent(payload={}))
        ...
        try:
            ...
            self._publish(ConnectionEstablishedEvent(payload={}))
    ...
    def _handle_disconnected(self, _event: object) -> None:
        ...
        self._publish(ConnectionLostEvent(payload={}))
        self._publish(ReconnectStartedEvent(payload={}))
